...
fn test_multiple_merkle_hashes() {
    ...
    let merkle_hashes = b"78175171f830d9ea3e67170dfdec6bd805d31b22b19eaf783355adae06faa3539762500f0eca01a59f0e198522a0752f96be9032803fb21311a992089b9472bd1361a2db43a580e40f81bd5e17eabae8eebb02e9a651ae348d88d51ca824df19".read_with::<VarArray<UInt256>>(&mut 0, byte::LE).unwrap().1;
    ...
    let merkle_tree = MerkleTree {
        ...
        hashes: merkle_hashes.clone(),
        flags: merkle_flags.as_slice(),
    };

    let has_valid_coinbase = merkle_tree.has_root(desired_merkle_root);
    println!("merkle_tree: {:?} {:?} {}, has_valid_coinbase: {} {:?}", merkle_hashes, merkle_flags.to_hex(), total_transactions, has_valid_coinbase, desired_merkle_root);
