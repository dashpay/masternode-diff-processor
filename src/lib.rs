...
use crate::processing::processor::{MasternodeManager, ProcessorContext, QuorumSelectionType};
...
#[no_mangle]
pub unsafe extern fn unregister_processor(processor: *mut MasternodeManager) {
