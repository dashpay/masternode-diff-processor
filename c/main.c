...
int main (void) {
    ...
    struct MasternodeManager *processor = register_processor(getBlockHeightByHash, NULL, NULL, NULL, NULL, NULL, NULL, NULL, &context);
    ...
    struct LLMQRotationInfoResult *result = process_llmq_rotation_info_result2(buffer, filelen, 0, 0, true, processor);
    printf("--------------\n process \n--------------\n");
    printf("%p\n", result);
    printf("\n");
